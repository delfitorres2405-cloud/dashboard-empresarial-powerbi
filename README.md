...
- Si bien la categoría Esporádicos/Bajo Valor es la más numeroso (casi el 44%), la categoría VIP también representa una porción considerable de la base. **Esta es la categoría de mayor prioridad comercial**, ya que compran seguido y esa frecuencia se traduce en rentabilidad. Para esto, se tuvieron en cuenta aquellos clientes que hicieron más de dos pedidos y cuya ganancia total generada es mayor a la ganancia media de todos los clientes.
